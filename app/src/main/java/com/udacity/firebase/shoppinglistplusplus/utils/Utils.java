...
public class Utils {
    ...
    // to have the updated property/value passed in.

    // TODO the second method is updateMapWithTimestampLastChanged.
    // This method will similarly take in a Hash Map of String to Objects. It will then set all copies
    // of the desired shopping list to have their TimestampLastChanged updated with the
    // ServerValue.TIMESTAMP value.
